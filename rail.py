...
def login():
    ...
    connection = con.connect(host="localhost",port ="3307" ,user="root", password="snk2404", database="railway")
...
def booked():
    ...
    if number_of_passengers==2:
        import mysql.connector as my
        con=my.connect(host="localhost",port="3307",user='root',password='snk2404',db='railway')
        cursor=con.cursor()
...
def train():
    ...
    con=connection.connect(host="localhost",port="3307" ,user="root",password="snk2404",db="railway")
    cursor=con.cursor()
